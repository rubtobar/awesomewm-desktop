...
beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "rubtobar"))
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "browse", "focus"}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.spawn("./.config/rofi/launchers/colorful/launcher.sh") end,
    ...
    awful.key({ modkey, "Control" }, "l", function() awful.spawn("i3lock-fancy") end,
